'use strict';
/**
 * backend/engine/styleRules.js
 * Style categories, pairing rules, gender-specific combos
 */

const { hasNeutral, hasBright, hasEarthy, hasClassic, hasPastel, hasSimilarFamily } = require('./colorDetector');
...
const GENDER_COMBO_DB = {
  women: {
    ...
    light_medium: [
      ...
      { name:'Muted Teal Edit',      pieces:['Muted teal shirt dress','Tan belt','Cream mules','Bronze earrings'],               vibe:'Effortless and refined',     occasion:'Weekend',    colors:['Muted Teal','Tan','Bronze'],        whyMatch:'Muted teal provides flattering contrast without harshness.' },
    ],
    medium: [
  ...
  men: {
    ...
    ebony: [
      { name:'Cobalt White Statement',pieces:['Cobalt shirt','Pure white trousers','Gold watch','White sneakers'],           vibe:'Sharp and luminous',         occasion:'Events',       colors:['Cobalt','Pure White','Gold'],     whyMatch:'Cobalt and white are the ultimate contrast combination for ebony skin.' },
...
function resolveComboSkinTone(skinTone) {
  const map = { porcelain:'porcelain', fair:'fair', light:'light', light_medium:'light_medium', medium:'medium', olive:'olive', tan:'tan', deep:'deep', rich:'rich', dark:'dark', ebony:'ebony' };
...
module.exports = { STYLE_RULES, GOOD_PAIRS, BAD_PAIRS, GENDER_COMBO_DB, buildBestComboMatches };
